...
void OnTimer() 
  {
   ...
   if(ActiveTrading && loopCounter % 30 == 0) 
     {
      ...
      for(int i=0; i<numPairs;++i) 
        {
         if(CreateBuysCondition(pairNames[i],ActiveTradingGap,MaximumNetPositions,MaximumAbsolutePositions)) 
           {
         ...
         if(CreateSellsCondition(pairNames[i],ActiveTradingGap,MaximumNetPositions,MaximumAbsolutePositions)) 
           {
